...
{
    public partial class AgentMotiveExmatriculare : Form
    {
        public AgentMotiveExmatriculare()
        {
            InitializeComponent();
        }

        private void Agent_Motive_Exmatriculare_Load(object sender, EventArgs e)
        {
            //A1
            config(true);
            refresh();
        ...
        {
            this.motiveExmatriculariTableAdapter.Fill(this.dataSet1.MotiveExmatriculari);
        }
        ...
        private void btnSalvare_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                this.motiveExmatriculariTableAdapter.Update(this.dataSet1.MotiveExmatriculari);
                config(true);
                refresh();
            }
            catch (Exception exc)
