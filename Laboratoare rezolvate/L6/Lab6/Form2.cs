...
namespace Lab6
{
    public partial class Form2 : Form
    {
        ...
        private void tema5ToolStripMenuItem_Click(object sender, EventArgs e)
        {
            Form6 tema5 = new Form6();
            tema5.ShowDialog();
        }

        private void tema6ToolStripMenuItem_Click(object sender, EventArgs e)
        {
            Form7 tema6 = new Form7();
            tema6.ShowDialog();
        }
    }
}
